 ...
 * @return is successful
 */
Status BST_preorderR(NodePtr, void (*visit)(NodePtr));//change log:BSTptr->nodeptr
 ...
 * @return is successful
 */
Status BST_inorderR(NodePtr, void (*visit)(NodePtr));//change log:BSTptr->nodeptr
 ...
 * @return is successful
 */
Status BST_postorderR(NodePtr, void (*visit)(NodePtr));//change log:BSTptr->nodeptr
